            ...
            <form class="form-horizontal add-franc" method="post"  action="{{route('admin.updateTreatmentProduct')}}">
				...
				<div class="form-group mt-5">
				  ...
				  <div class="form-group">
					<div class="row">
						...
						<div class="col-lg-10">
                              <input type="text" name="tcode" readonly value="{{$Treatments->treatment_code}}" onkeypress="return IsAlphaNumeric(event)" class="form-control" placeholder="Treatment Code"  required>
						</div>
					</div>
                  </div>
				  ...
				  <div class="form-group">
					<div class="row">
						...
						<div class="col-lg-10">
                              <input type="text" name="tname" value="{{$Treatments->treatment_name}}" class="form-control" onkeypress="return IsAlphaNumeric(event)" placeholder="Treatment Name"  required>
						</div>
					</div>
                  </div>
					...
					<div class="row">
						...
						<div class="col-lg-10">
                              <input type="text" name="a_unit" onkeypress="return isNumberKey(event);" value="{{$Treatments->available_unit}}" class="form-control" placeholder="Available Unit" >
						</div>
					</div>
                  </div>
				   ...
				   <div class="form-group">
					<div class="row">
						...
						<div class="col-lg-10">
                              <input type="text" name="tprice" value="{{$Treatments->treatment_price}}"  onkeypress="return isFloatNumber(event)" class="form-control" placeholder="Treatment Price"  required>
						</div>
					</div>
                  </div>
				...
				<div class="form-group">
					<div class="row">
					   ...
					   <div class="col-lg-10">										
								<textarea class="form-control" rows="3" name="comment" onkeypress="return IsAlphaNumeric(event)"  id="comment">{{$Treatments->description}}</textarea>
						</div>	
					</div>
				</div> 
