...
@section('body-content')
    ...
    <div class="container-fluid home">
            ...
            <div class="row">
				<div class="col-md-12">
				<form class="form-horizontal add-franc" method="post"  action="{{route('franchise.PostAddAppointment')}}">
                    @csrf
						...
						<div class="row">
							...
							<div class="col-lg-6">						
								<div class="row">
									...
									<div class="col-lg-9">				
										  <input type="text" name="bid" id="bid" placeholder="Booking ID" class="form-control"> 						
									</div> 
								</div> 
							</div>					
                       </div>						
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="row">
								...
								<div class="col-lg-8">				
									 	<input type="number" name="bdeposit" class="form-control" placeholder="Booking Deposit"> 						
								</div> 
							</div> 
							</div>
							...
							<div class="col-lg-6">						
								<div class="row">
									...
									<div class="col-lg-9">				
										  <input type="number" name="tfee" placeholder="Treatment Fee" class="form-control"> 						
									</div> 
								</div> 
							</div>					
                       </div>						
						...
						<div class="row">
							...
							<div class="row">
								<div class="col-lg-4"><label for="allot-date">Allotment Date:</label></div>
									<div class="col-lg-8">				
										<input type="date" placeholder="Allotment Date" class="form-control" id="allot-date" name="allotment_date"> 						
								</div>  
							</div> 
							</div>
							...
							<div class="col-lg-6">						
								<div class="row">
									...
									<div class="col-lg-8">				
										  <input type="time" name="atime" placeholder="Appointment Time" class="form-control"> 						
									</div> 
								</div> 
							</div>					
                       </div>						
